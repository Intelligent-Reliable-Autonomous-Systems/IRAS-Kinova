...
class IsaacPolicyController(Node):
    ...
    def __init__(self, name) -> None:
        ...
        self.declare_parameter("cmd_topic", "/joint_command")
        ...
        self.traj_pub = self.create_publisher(JointState, self.cmd_topic, 10)
    ...
    def robot_cmd_callback(self) -> None:
        ...
        if joint_pos is not None:
            if len(joint_pos) != self.num_actions:
                ...
                traj.position = joint_pos.tolist()[: self.num_actions]
